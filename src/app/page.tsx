          ...
          <div className="flex items-center justify-center gap-6 sm:gap-10">
            {[
              ...
              },
              {
                ...
                icon: (
                  <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
                    <line x1="12" y1="0" x2="12" y2="24" />
                    <line x1="0" y1="12" x2="24" y2="12" />
                    <line x1="3" y1="3" x2="21" y2="21" />
                    <line x1="21" y1="3" x2="3" y2="21" />
                    <rect x="4" y="4" width="16" height="16" fill="none" strokeWidth="1.8" />
                  </svg>
                ),
              },
            ].map((llm) => (
