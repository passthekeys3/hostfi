...
const INTEGRATIONS: Integration[] = [
  ...
  { id: "hostaway", name: "Hostaway", description: "Import reservations and revenue", category: "Property Management", status: "available", logo: "H", logoColor: "bg-white border border-gray-200", logoUrl: "/logos/hostaway.svg", tier: "pro" },
  { id: "guesty", name: "Guesty", description: "Sync bookings, payouts, and property data", category: "Property Management", status: "available", logo: "G", logoColor: "bg-[#00695C]", logoUrl: "/logos/guesty.svg", tier: "pro" },
  { id: "ownerrez", name: "OwnerRez", description: "Import reservations and financial data", category: "Property Management", status: "available", logo: "OR", logoColor: "bg-[#4CAF50]", logoUrl: "/logos/ownerrez.svg", tier: "pro" },
