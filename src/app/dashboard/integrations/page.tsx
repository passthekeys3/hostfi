...
const INTEGRATIONS: Integration[] = [
  { id: "quickbooks", name: "QuickBooks Online", description: "Sync expenses and revenue to your ledger", category: "Accounting", status: "disconnected", logo: "QB", logoColor: "bg-[#2CA01C]", logoUrl: "/logos/quickbooks.svg", tier: "business" },
  { id: "xero", name: "Xero", description: "Two-way sync with expenses and revenue", category: "Accounting", status: "disconnected", logo: "XO", logoColor: "bg-[#13B5EA]", logoUrl: "/logos/xero.svg", tier: "business" },
  { id: "plaid", name: "Bank Accounts (Plaid)", description: "Auto-import and categorize transactions", category: "Banking", status: "disconnected", logo: "PL", logoColor: "bg-[#111111]", logoUrl: "/logos/plaid.svg", tier: "pro" },
  { id: "melio", name: "Melio", description: "Pay bills directly — ACH free on paid plans", category: "Payments", status: "disconnected", logo: "ML", logoColor: "bg-[#00C2FF]", logoUrl: "/logos/melio.svg", tier: "free" },
  ...
  { id: "dropbox", name: "Dropbox", description: "Sync receipts and reports by property", category: "Productivity", status: "disconnected", logo: "DB", logoColor: "bg-[#0061FF]", logoUrl: "/logos/dropbox.svg", tier: "pro" },
  ...
  { id: "teams", name: "Microsoft Teams", description: "Upload receipts, get alerts and summaries", category: "Team", status: "disconnected", logo: "MT", logoColor: "bg-[#6264A7]", logoUrl: "/logos/teams.svg", tier: "business" },
