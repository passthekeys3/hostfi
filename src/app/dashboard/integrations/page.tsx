...
const INTEGRATIONS: Integration[] = [
  ...
  { id: "turno", name: "Turno", description: "Auto-import cleaning costs — coming soon", category: "Operations", status: "coming_soon", logo: "TN", logoColor: "bg-[#1E3A5F]", logoUrl: "/logos/turno.svg", tier: "pro" },
  ...
  { id: "pricelabs", name: "PriceLabs", description: "Revenue projections and pricing data — coming soon", category: "Operations", status: "coming_soon", logo: "PL", logoColor: "bg-[#FF6B35]", logoUrl: "/logos/pricelabs.svg", tier: "pro" },
