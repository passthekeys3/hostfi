...
const INTEGRATIONS: Integration[] = [
  ...
  { id: "hostaway", name: "Hostaway", description: "Import reservations and revenue", category: "Property Management", status: "available", logo: "HA", logoColor: "bg-[#FF6B35]", logoUrl: "/logos/hostaway.svg", tier: "pro" },
  ...
  { id: "ownerrez", name: "OwnerRez", description: "Import reservations and financial data", category: "Property Management", status: "available", logo: "OR", logoColor: "bg-[#1A73E8]", logoUrl: "/logos/ownerrez.svg", tier: "pro" },
