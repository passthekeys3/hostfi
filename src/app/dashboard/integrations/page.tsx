...
const INTEGRATIONS: Integration[] = [
  { id: "quickbooks", name: "QuickBooks Online", description: "Sync expenses and revenue to your ledger", category: "Accounting", status: "disconnected", logo: "QB", logoColor: "bg-[#2CA01C]", logoUrl: "/logos/quickbooks.png", tier: "business" },
  { id: "xero", name: "Xero", description: "Two-way sync with expenses and revenue", category: "Accounting", status: "disconnected", logo: "XO", logoColor: "bg-[#13B5EA]", logoUrl: "/logos/xero.png", tier: "business" },
  { id: "plaid", name: "Bank Accounts (Plaid)", description: "Auto-import and categorize transactions", category: "Banking", status: "disconnected", logo: "PL", logoColor: "bg-[#111111]", logoUrl: "/logos/plaid.png", tier: "pro" },
  { id: "melio", name: "Melio", description: "Pay bills directly — ACH free on paid plans", category: "Payments", status: "disconnected", logo: "ML", logoColor: "bg-[#00C2FF]", logoUrl: "/logos/melio.png", tier: "free" },
  { id: "hostaway", name: "Hostaway", description: "Import reservations and revenue", category: "Property Management", status: "coming_soon", logo: "HA", logoColor: "bg-[#FF6B35]", logoUrl: "/logos/hostaway.png", tier: "pro" },
  { id: "guesty", name: "Guesty", description: "Sync bookings, payouts, and property data", category: "Property Management", status: "coming_soon", logo: "GY", logoColor: "bg-[#00BFA5]", logoUrl: "/logos/guesty.png", tier: "business" },
  { id: "ownerrez", name: "OwnerRez", description: "Import reservations and financial data", category: "Property Management", status: "coming_soon", logo: "OR", logoColor: "bg-[#1A73E8]", logoUrl: "/logos/ownerrez.png", tier: "pro" },
  { id: "google_sheets", name: "Google Sheets", description: "Live sync expenses and P&L to Sheets", category: "Productivity", status: "disconnected", logo: "GS", logoColor: "bg-[#0F9D58]", logoUrl: "/logos/google-sheets.png", tier: "pro" },
  { id: "google_drive", name: "Google Drive", description: "Auto-backup receipts and reports", category: "Productivity", status: "disconnected", logo: "GD", logoColor: "bg-[#4285F4]", logoUrl: "/logos/google-drive.png", tier: "pro" },
  { id: "dropbox", name: "Dropbox", description: "Sync receipts and reports by property", category: "Productivity", status: "disconnected", logo: "DB", logoColor: "bg-[#0061FF]", logoUrl: "/logos/dropbox.png", tier: "pro" },
  { id: "slack", name: "Slack", description: "Upload receipts, get alerts and summaries", category: "Team", status: "disconnected", logo: "SL", logoColor: "bg-[#4A154B]", logoUrl: "/logos/slack.png", tier: "business" },
  { id: "teams", name: "Microsoft Teams", description: "Upload receipts, get alerts and summaries", category: "Team", status: "disconnected", logo: "MT", logoColor: "bg-[#6264A7]", logoUrl: "/logos/teams.png", tier: "business" },
  { id: "zapier", name: "Zapier", description: "Connect to 5,000+ apps", category: "Automation", status: "disconnected", logo: "ZP", logoColor: "bg-[#FF4A00]", logoUrl: "/logos/zapier.png", tier: "business" },
  { id: "make", name: "Make", description: "Visual workflow automation", category: "Automation", status: "disconnected", logo: "MK", logoColor: "bg-[#6D00CC]", logoUrl: "/logos/make.png", tier: "business" },
