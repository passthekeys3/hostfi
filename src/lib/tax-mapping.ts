...
export const OWNER_SCHEDULE_E_LINES: ScheduleELine[] = [
  ...
  { line: 8, description: 'Cleaning and maintenance', categories: ['cleaning', 'maintenance'], ownerOnly: true },
...
export const ARBITRAGE_SCHEDULE_E_LINES: ScheduleELine[] = [
  ...
  { line: 8, description: 'Cleaning and maintenance', categories: ['cleaning', 'maintenance'], arbitrageOnly: true },
